...
const issuesFoundTemplate: IssuesFound = (
  ...
  return `
    ...
    <a href="https://www.a11ywatch.com/reports/${page}" style="font-weight: 800; font-size: 1.8em; display: block; background: #111; padding: 8px; color: #fff; text-align: center; text-decoration: none;">Share Report</a>
