...
const issuesFoundTemplate: IssuesFound = (
  ...
  return `
    ...
    <a href="https://a11ywatch.com/dashboard" style="font-weight: 800; font-size: 1.8em; display: block; background: #5c6bc0; padding: 8px; color: white; text-align: center; text-decoration: none;">View Details</a>
